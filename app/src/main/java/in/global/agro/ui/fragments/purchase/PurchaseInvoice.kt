...
import `in`.global.agro.data.model.PurchaseInvoiceModel
import `in`.global.agro.databinding.FragmentPurchaseInvoiceBinding
...
class PurchaseInvoice : Fragment(R.layout.fragment_purchase_invoice) {

    private lateinit var binding:FragmentPurchaseInvoiceBinding
    private var xOff = 0F
    private var yOff = 0F
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding= FragmentPurchaseInvoiceBinding.bind(view)
                ...
                when {
                    ...
                    quantity.text.toString().isEmpty() -> {
                        ...
                        lifecycleScope.launchWhenStarted {
                             ...
                             val purchaseInvoiceModel=   PurchaseInvoiceModel(
                                    1,
                            ...
                            val action=PurchaseInvoiceDirections.actionPurchaseInvoiceToPurchaseInvoicePreview(purchaseInvoiceModel)
